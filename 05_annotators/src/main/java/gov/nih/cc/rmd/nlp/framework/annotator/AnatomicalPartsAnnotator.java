// =================================================
/**
 * anatomicalPartsAnnotator identifies those anatomical parts that would be
 * part of a symptom expression - eyes, ears, back, hand etc.  Not paricardium sac or
 * something that a consumer would not be able to feel, see, hear, or smell with.
 *
 * @author  Guy Divita 
 * @created Dec 5, 2014
 *
...
public class AnatomicalPartsAnnotator extends JCasAnnotator_ImplBase {
 
  public static final String annotatorName = AnatomicalPartsAnnotator.class.getSimpleName();
	         ...
	         if (terms != null) {
	           ...
	           for (Annotation term : terms ) {
	             ...
	             if ((semanticTypes = ((LexicalElement) term).getSemanticTypes()) != null) {
	               if (semanticTypes.contains("anatomicalPart")) {
	                 // ------------------------------------------------------
                   ...
                   if ( !isPartOfSectionHeading( pJCas, sectionAndContentHeadingAnnotations,  term ) ) { 
                     try {
                       createAnnotation(pJCas, Class.forName("gov.va.vinci.model.AnatomicalPart"), (LexicalElement) term);
	     ...
	     //-----------------------------------------
	       ...
	       private void createAnnotation( JCas pJCas, Class<?> uimaLabelClass, LexicalElement pTerm ) {
	         ...
	         try {
	           ...
	           String provenence = "anatomicalPartAnnotator" ;
