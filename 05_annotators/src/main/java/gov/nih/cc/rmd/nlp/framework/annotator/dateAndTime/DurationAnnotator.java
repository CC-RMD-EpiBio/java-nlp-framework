...
public class DurationAnnotator extends DateAndTimeAnnotator {
...
public void initialize(String[] pArgs) throws ResourceInitializationException {
  ...
  try {
    ...
    String   _manualPositiveRegExPatterns = "resources/com/ciitizen/framework/dateAndTime/durationRegularExpressions.txt";
