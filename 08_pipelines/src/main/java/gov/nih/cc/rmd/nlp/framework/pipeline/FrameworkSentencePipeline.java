...
import gov.nih.cc.rmd.nlp.framework.annotator.SlotValueNoNewLineAnnotator;
...
import gov.nih.cc.rmd.nlp.framework.annotator.Sections.SemanticWindowAnnotator;
...
// =================================================
/**
 * FrameworkSentencePipeline  chunks documents into utterances via Frameworks annotators
 * It uses the combined framework and ctakes type descriptors.
 ...
 */
  ...
  public class FrameworkSentencePipeline extends AbstractPipeline  {
     ...
     */
    // =======================================================
    public FrameworkSentencePipeline(String[] pArgs) {
      super(pArgs);
     ...
     */
    // -----------------------------------------
    public FrameworkSentencePipeline()  throws Exception {
     super( );
  ...
  */
  // =================================================
   public synchronized static void setPipeline(FrameworkPipeline pipeline, String[] pArgs) {
    ...
    // pipeline.add(   SlotValueNoNewLineAnnotator.class.getCanonicalName(), argsParameter );
  ...
  //   pipeline.add(         PersonTokensAnnotator.class.getCanonicalName(), argsParameter); //<--- new tokens are created in term - need to do it again
    ...
    // pipeline.add(       QuestionAnswerAnnotator.class.getCanonicalName(), argsParameter );  <--- not working
     ...
     pipeline.add(         PersonTokensAnnotator.class.getCanonicalName(), argsParameter);
     pipeline.add(         PersonTokensAnnotator.class.getCanonicalName(), argsParameter);
