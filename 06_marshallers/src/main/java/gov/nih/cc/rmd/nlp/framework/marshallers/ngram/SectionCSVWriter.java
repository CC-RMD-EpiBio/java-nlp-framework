// =================================================
/**
 * SectonCSV writer writes out a row for each section seen in a document
 * along with it's document type and station and year if it's available.
 * 
 *  These are going into csv files (one per process)
 *  
 *  documentId|sta3n|enterpriseDocumentType|date|SectionName|SectionSize (devoid of section name)
 *     
 *        
 * @author  Guy Divita 
 * @created feb 1, 2017
...
public class SectionCSVWriter extends gov.nih.cc.rmd.nlp.framework.marshallers.writer.AbstractWriter  {
...
// =======================================================
   ...
   */
  // =======================================================
  public SectionCSVWriter(String[] pArgs) throws ResourceInitializationException {
    initialize( pArgs);
  }
