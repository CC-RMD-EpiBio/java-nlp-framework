 ...
 * 
 * This evalates at the token level - exact match for tokens
 * but ignores entity boundaries. 
 *       
 * @author  Guy Divita 
...
public class TokenEvaluateWithAttributeAnnotator extends JCasAnnotator_ImplBase implements Writer {
...
// =================================================
  ...
  **/
  // =================================================
  public TokenEvaluateWithAttributeAnnotator(String[] pArgs) throws ResourceInitializationException {
    initialize( pArgs);
...
buff.append("\n\n\n\n"); 
 ...
 return buff.toString();
  ...
  // Global Variables
  // ---------------------------------------
  public static final String annotatorName = TokenEvaluateWithAttributeAnnotator.class.getSimpleName();
